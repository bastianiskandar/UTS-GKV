...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Segitiga", NULL, NULL);
    glfwMakeContextCurrent(window);
    gladLoadGLLoader((GLADloadproc)glfwGetProcAddress);

    // Data: x, y, r, g, b
    float vertices[] = {
         0.0f,  0.5f,  1.0f, 0.0f, 0.0f,  // atas  - merah
        -0.5f, -0.5f,  0.0f, 1.0f, 0.0f,  // kiri  - hijau
         0.5f, -0.5f,  0.0f, 0.0f, 1.0f   // kanan - biru
    };
...
int main(int argc, char** argv) {
    ...
    glutMainLoop();
>>>>>>> 4b68198e218689c169c1316dae899f47faa87184
    return 0;
}
